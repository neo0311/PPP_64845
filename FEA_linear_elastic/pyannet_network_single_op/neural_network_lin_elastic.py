...
linear_elastic_nn = NeuralNetwork((3,8, 10, 8,1),activations=('swish','swish','swish','linear'))
linear_elastic_nn.construct_parameters()
linear_elastic_nn.load_nn('linear_elastic_oneop_data.npy')
...
#linear_elastic_nn.save_nn('linear_elastic_oneop')
#print(y_test,'\n\n', linear_elastic_nn.predict(X_test))