...
material_routine_nn.train_and_assess(X_train, y_train, X_test, y_test, type= "SGD", num_of_epochs = 10000, learning_rate = 1e-4 ,stop_condition = 1000, batch_size= 32, optimizer = 'adam', plotting=True, output=True, output_metrics=('rmse', 'mse', 'mae', 'mape', 'r2'))
material_routine_nn.save_nn('material_routine_allop_transformed')
