...
andro_nn.train_and_assess(X_train, y_train,X_test, y_test, type= "SGD", num_of_epochs = 1000000, learning_rate = 1e-4 ,stop_condition = 30000, batch_size= 8, optimizer = 'adam', plotting=True, output=True, output_metrics=('rmse', 'mse', 'mae', 'mape', 'r2'))
